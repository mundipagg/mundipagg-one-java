...
public class IntegrationXmlTest {
    ...
    public void CreateSale() {
        ...
        createSaleRequest.setRequestKey(UUID.randomUUID());
        createSaleRequest.setBuyer(buyer);
        
        try {
            // Cria o cliente que vai enviar a transação
            GatewayServiceClient serviceClient = new GatewayServiceClient(merchantKey, environment, HttpContentTypeEnum.Xml);
